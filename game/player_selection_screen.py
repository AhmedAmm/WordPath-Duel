...
def draw_player_selection_screen(screen, duck_1, duck_2, selected_duck):
    ...
    duck_1_pos = (WINDOW_WIDTH // 2 - 250, WINDOW_HEIGHT // 2 - 100)
    duck_2_pos = (WINDOW_WIDTH // 2 + 50, WINDOW_HEIGHT // 2 - 100)
    ...
    confirm_button = pygame.Rect(WINDOW_WIDTH // 2 - 75, WINDOW_HEIGHT // 2 + 150, 150, 40)
